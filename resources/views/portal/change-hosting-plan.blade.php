...
@section('content')
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">Change Hosting Plan</h1>
            <div>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Change Hosting Plan</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
        <div class="row">
            <Center><h3 class="card-title mt-4">Secure web hosting that grows with your business</h3>
                <h5>Premium web hosting with 24/7/365 technical support, 99.99% uptime and a risk-free money-back
                    guarantee. <br><br></h5></Center>
            <!-- ROW-4 OPEN -->
                    ...
                    <div class="princing-item">
                        <div class="pricing-divider text-center pt-5">
                            ...
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                       enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path fill="#6C5FFC"
                            ...
                            <h4 class="display-5 text-primary fw-bold my-3"><span class="h3">$</span> $25 <span
                                        class="h5">/month</span></h4>
                        </div>
                        <div class=" br-be-0 br-bs-0 bg-white mt-0 shadow">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><i
                                            class="fe fe-check text-primary p-2 fw-bold"></i><b>10GB</b> SSD Storage
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-primary p-2 fw-bold"></i><b>Unlimtied</b>
                                    Bandwidth
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-primary p-2 fw-bold"></i><b>Email
                                        Accounts</b>2 emails
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-primary p-2 fw-bold"></i><b>
                                        24/7</b> support
                                </li>
                                <li class="list-group-item border-bottom-0"><i
                                            class="fe fe-check text-primary p-2 fw-bold"></i><b>Help center access</b>
                                </li>
                            </ul>
            ...
            <div class="col-sm-6 col-xl-3 col-md-6 col-lg-6 danger">
                <div class="card">
                    <div class="princing-item">
                        <div class="pricing-divider text-center pt-5">
                            <h2 class="text-danger">Silver</h2>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                       enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path fill="#E82646"
                            ...
                            <h4 class="display-5 text-danger fw-bold my-3"><span class="h3">$</span> 50 <span
                                        class="h5">/month</span></h4>
                        </div>
                        <div class=" br-be-0 br-bs-0 bg-white mt-0 shadow">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><i class="fe fe-check text-danger p-2 fw-bold"></i><b>10</b>
                                    users included for this pack
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-danger p-2 fw-bold"></i><b>2
                                        GB</b> of storage you will get
                                </li>
                                <li class="list-group-item"><i
                                            class="fe fe-check text-danger p-2 fw-bold"></i><b>Free </b>Email support
                                    for every user
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-danger p-2 fw-bold"></i><b>
                                        24/7</b> support
                                </li>
                                <li class="list-group-item border-bottom-0"><i
                                            class="fe fe-check text-danger p-2 fw-bold"></i><b>Help center access</b>
                                </li>
                            </ul>
                            <div class="card-footer text-center p-5">
                                <button type="button" class="btn btn-danger btn-block">Sign Up Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="princing-item">
                        <div class="pricing-divider text-center pt-5">
                            ...
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                       enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path fill="#09AD95"
                            ...
                            <h4 class="display-5 text-success fw-bold my-3"><span class="h3">$</span> 100 <span
                                        class="h5">/month</span></h4>
                        </div>
                        <div class=" br-be-0 br-bs-0 bg-white mt-0 shadow">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><i
                                            class="fe fe-check text-success p-2 fw-bold"></i><b>10</b> users included
                                    for this pack
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-success p-2 fw-bold"></i><b>2
                                        GB</b> of storage you will get
                                </li>
                                <li class="list-group-item"><i
                                            class="fe fe-check text-success p-2 fw-bold"></i><b>Free </b>Email support
                                    for every user
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-success p-2 fw-bold"></i><b>
                                        24/7</b> support
                                </li>
                                <li class="list-group-item border-bottom-0"><i
                                            class="fe fe-check text-success p-2 fw-bold"></i><b>Help center access</b>
                                </li>
                            </ul>
                            <div class="card-footer text-center p-5">
            ...
            <div class="col-sm-6 col-xl-3 col-md-6 col-lg-6 secondary">
                <div class="card border border-secondary p-1">
                    ...
                    <div class="princing-item">
                        <div class="pricing-divider text-center pt-5">
                            <h2 class="text-secondary">Premium VPS</h2>
                            <span>
                            ...
                            <h4 class="display-5 text-secondary fw-bold my-3"><span class="h3"> Starting $</span> 200
                                <span class="h5">/month</span></h4>
                        </div>
                        <div class=" br-be-0 br-bs-0 bg-white mt-0 shadow">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><i
                                            class="fe fe-check text-secondary p-2 fw-bold"></i><b>10</b> users included
                                    for this pack
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-secondary p-2 fw-bold"></i><b>2
                                        GB</b> of storage you will get
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-secondary p-2 fw-bold"></i><b>Free </b>Email
                                    support for every user
                                </li>
                                <li class="list-group-item"><i class="fe fe-check text-secondary p-2 fw-bold"></i><b>
                                        24/7</b> support
                                </li>
                                <li class="list-group-item border-bottom-0"><i
                                            class="fe fe-check text-secondary p-2 fw-bold"></i><b>Help center access</b>
                                </li>
                            </ul>
                            <div class="card-footer text-center p-5">
